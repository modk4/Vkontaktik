...
#define kVKAPIApplicationName    @"vkontaktik"
#define kVKAPIApplicationVersion @"1.0"
/* The rule a User-Agent string'll be generated with */
#define kVKAPIUserAgentString [NSString stringWithFormat: @"%@ (v.%@) via Andy Apps", kVKAPIApplicationName, kVKAPIApplicationVersion]
